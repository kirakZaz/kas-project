...
const FEATHERS = [
    ...
    { top: '15%', right: '5%', size: 35, delay: 3, duration: 22, rotate: -25 },
    { top: '28%', left: '3%', size: 40, delay: 7, duration: 20, rotate: 30 },
    { top: '42%', right: '10%', size: 55, delay: 2, duration: 25, rotate: -15 },
    { top: '55%', left: '6%', size: 30, delay: 10, duration: 19, rotate: 45 },
    { top: '65%', right: '3%', size: 45, delay: 5, duration: 23, rotate: -35 },
    { top: '78%', left: '10%', size: 38, delay: 8, duration: 21, rotate: 20 },
    { top: '88%', right: '7%', size: 42, delay: 1, duration: 17, rotate: -40 },
    { top: '35%', left: '92%', size: 32, delay: 12, duration: 24, rotate: 10 },
    { top: '50%', left: '2%', size: 48, delay: 6, duration: 20, rotate: -20 },
    { top: '72%', right: '12%', size: 36, delay: 9, duration: 22, rotate: 35 },
